...
export default function V4Contact() {
	...
	return (
		<section
			...
			aria-labelledby="v4-contact-heading"
		>
			<div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
				...
				<Reveal delay={0.1}>
					<form action={handleSubmit} className="v4-glass flex flex-col gap-5 rounded-2xl p-6 sm:p-8">
						<input
							type="text"
							name="website"
							tabIndex={-1}
						...
						<div>
							<label htmlFor="v4-senderEmail" className="mb-2 block font-satoshi text-sm font-medium text-brand-ivory">
								Your email
							</label>
							<input
								id="v4-senderEmail"
						...
						<div>
							<label htmlFor="v4-message" className="mb-2 block font-satoshi text-sm font-medium text-brand-ivory">
								Message
							</label>
							<textarea
								id="v4-message"
