...
export function MarkMA({ className = "", title = "Marco Antolini" }: MarkProps) {
	return (
		<svg viewBox="0 0 60 40" fill="none" role="img" aria-label={title} className={className}>
			<path d="M6 33 V7 L16 21 L26 7 V33" stroke="currentColor" strokeWidth="3" strokeLinecap="square" strokeLinejoin="miter" />
			<path d="M33 33 L43 7 L53 33" stroke="currentColor" strokeWidth="3" strokeLinecap="square" strokeLinejoin="miter" />
