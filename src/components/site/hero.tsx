				...
				<div>
					...
					<div className="mt-10 flex flex-wrap items-center gap-3">
						...
						<a
							...
							aria-label="LinkedIn"
							className="site-glass inline-flex min-h-12 min-w-12 items-center justify-center rounded-full text-brand-muted transition-colors duration-200 hover:border-brand-emerald/40 hover:text-brand-emerald active:scale-[0.98] motion-reduce:transition-none motion-reduce:active:scale-100"
						>
							<LinkedInIcon />
						</a>
						<a
