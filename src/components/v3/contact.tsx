...
export default function V3Contact() {
	...
	return (
		<section
			...
			aria-labelledby="v3-contact-heading"
		>
			<div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
				<Reveal>
					<p className="v3-label">Contact</p>
					<h2
						id="v3-contact-heading"
						className="mt-4 font-satoshi text-3xl font-bold tracking-tight text-brand-ivory sm:text-[2.6rem] sm:leading-[1.05]"
					>
					...
					<ResponseTimeStatus variant="v3" className="mt-8" />
				...
				<Reveal delay={0.1}>
					<form action={handleSubmit} className="v3-glass flex flex-col gap-5 rounded-2xl p-6 sm:p-8">
						{/* Honeypots */}
						<input
							type="text"
							name="website"
						...
						<div>
							<label htmlFor="v3-senderEmail" className="mb-2 block font-satoshi text-sm font-medium text-brand-ivory">
								Your email
							</label>
							<input
								id="v3-senderEmail"
						...
						<div>
							<label htmlFor="v3-message" className="mb-2 block font-satoshi text-sm font-medium text-brand-ivory">
								Message
							</label>
							<textarea
								id="v3-message"
